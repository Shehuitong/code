...
VALUES
    ...
    (1, 1, 'DEPARTMENT', '已收藏', '2025-11-21 14:15:00', 0),
    ...
    (3, 1, 'DEPARTMENT', '已收藏', '2025-11-24 11:00:00', 0),
...
INSERT INTO Activity (
    ...
    created_time, apply_time, volunteer_hours, follower_count, hold_college, apply_grade
             ...
             '大学生程序设计竞赛', 1, '面向全校学生的编程竞赛，提升实战能力...', '2025-12-15 09:00:00', '2025-12-15 17:00:00',
...
INSERT INTO Activity (
    ...
    created_time, apply_time, volunteer_hours, follower_count, hold_college, apply_grade
             ...
             '数学建模讲座', 1, '数学建模技巧分享，涵盖竞赛与科研应用...', '2025-12-11 14:00:00', '2025-12-11 16:00:00',
             '图书馆报告厅', '全校', '1.4.人文与科学素养', 5, 100,
             80, 20, '2025-12-8 23:59:59', '报名进行中',
             '2025-05-22 15:00:00', '2025-12-6 00:00:00', 0.5, 45, '计算机学院', '2024级+2025级'
         );
...
INSERT INTO Activity (
    ...
    created_time, apply_time, volunteer_hours, follower_count, hold_college, apply_grade
             ...
             '志愿者招募活动', 1, '社区服务志愿者招募，累计志愿时长可加分...', '2025-12-21 08:00:00', '2025-12-21 18:00:00',
             '学校大礼堂', '全校', '1.1.科技竞赛', 10.00, 200,
             150, 50, '2025-12-20 23:59:59', '报名进行中',
             '2025-05-25 09:00:00', '2025-12-07 01:20:00', 1, 100, '电气学院', '2022级+2024级');
...
INSERT INTO Activity (
    ...
    created_time, apply_time, volunteer_hours, follower_count, hold_college, apply_grade
             ...
             '英语竞赛', 4, '面向全校学生的英语竞赛，提升实战能力...', '2025-12-20 09:00:00', '2025-12-20 17:00:00',
             '教学楼', '全校', '1.1.科技竞赛', 2.00, 50,
             25, 25, '2025-12-11 23:59:59', '报名进行中',
             '2025-05-20 10:00:00', '2025-12-7 00:00:00', 2, 84, '计算机学院', '2022级+2025级'
         );
 INSERT INTO DEPARTMENT ( DEPARTMENT_ID, DEPARTMENT_NAME, DESCRIPTION, LOGO_URL, CREATE_TIME,DEPARTMENT_COLLEGE) VALUES
(1, '学生会', '负责计算机科学与技术、软件工程等专业教学与科研', 'https://img.alicdn.com/i4/232692832/O1CN01QvQAAQ1Wn6T6g4Tqr_!!232692832.jpg', '2025-09-01 08:00:00','计算机学院'),
(2, '外联部', '涵盖英语、日语、法语等语种教学，培养涉外人才', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', '2025-09-01 08:30:00','外国语学院'),
(3, '体育部', '专注数学理论与应用研究，开设数学与应用数学、统计学专业', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', '2025-09-01 09:00:00','机械学院'),
(4, '校团委', '从事基础物理与应用物理研究，含光电、新能源方向', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', '2025-09-01 09:30:00','电气学院'),
(5, '宣传部', '宣传部门活动', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', '2025-09-01 09:30:00','法学院');


INSERT INTO DEPARTMENTADMIN (DEPARTMENT_ID, EMPLOYEE_ID, ADMIN_PASSWORD, ADMIN_NAME, ADMIN_AVATAR_URL
) VALUES
      ( 1, 'G2025001', 'Admin123', '张管理员', 'https://img.alicdn.com/i4/232692832/O1CN01QvQAAQ1Wn6T6g4Tqr_!!232692832.jpg'),
      ( 2, 'G2025002', 'Admin123', '李管理员', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg'),
      ( 3, 'G2025003', 'Admin123', '王管理员', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg'),
      ( 4, 'G2025004', 'Admin123', '赵管理员', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg');

-- 插入USER表数据
INSERT INTO "USER" (USERNAME, STUDENT_ID, COLLEGE, GRADE, PHONE, AVATAR_URL, PASSWORD) VALUES
-- 2022级 外国语学院（001） 座位01
('张三', '202200101', '外国语学院', '2022级', '13800138001', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', 'Aa202200101'),
-- 2023级 计算机学院（002） 座位08
('李四', '202300208', '计算机学院', '2023级', '13900139002', 'https://avatar.default.com/1.jpg', 'Aa202300208'),
-- 2024级 数学学院（003） 座位15
('王五', '202400315', '机械学院', '2024级', '13700137003', 'https://img.keaitupian.cn/newupload/04/1712045050573620.jpg', 'Aa202400315'),
-- 2025级 物理学院（004） 座位22
