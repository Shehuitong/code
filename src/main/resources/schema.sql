...
VALUES
    ...
    (1, 5, 'DEPARTMENT', '已收藏', '2025-11-24 11:00:00', 0),
    -- 用户ID=2 收藏 部门ID=1（其他用户的收藏数据，用于测试权限隔离）
    (1, 1, 'DEPARTMENT', '已收藏', '2025-11-25 13:30:00', 0),
    -- 用户ID=2 关注 活动ID=3（其他用户的关注数据）
    (1, 3, 'ACTIVITY', '已收藏', '2025-11-26 15:50:00', 0);
...
INSERT INTO Activity (
    ...
    created_time, apply_time, volunteer_hours, follower_count, hold_college, apply_grade
             ...
             '2025-05-20 10:00:00', '2025-06-01 00:00:00', 2, 84, '计算机学院', '2023级+2024级'
         );
